...
The Civic Cloud Collaborative is asking the City of Burlington to fund the costs incurred by Burlington Telecom for the infrastructure needed by the Civic Cloud. This includes physical space, electricity, air conditioning, bandwidth, and an IPv4 address block. The Civic Cloud Collaborative has procured all of the equipment and labor necessary for phase 1 of the Civic Cloud, with an estimated value of $26,100. The costs to the City of Burlington will be minimal relative to the Civic Cloud Collaborative total budget of $213,560 for phase 1, phase 2, and year one of phase 3. However, support from the City of Burlington will be critical in leveraging the funding needed for phase 2 and phase 3. 
